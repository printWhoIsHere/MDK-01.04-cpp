...
size_t Minutes = 5; // Сколько минут отведено на игру
size_t Seconds = 0; // Отчёт всегда с ровным минут
...
void easterEgg() {
    ...
    {
        srand(time(NULL));
        short smile = rand() % (97 - 91) + 91;
        cout << "\x1b[" << smile << "mxXxXxXxXxXxXx" << "\x1b[0m";
    }
}
...
void rules() {
    ...
    cout << "\n\n***  \"Правила\"  ***\t\t\t\n";
    cout << "\x1b[31m--------------------\x1b[0m\n";
    cout << " Правила просты. \n Приятной игры \x1b[92m" << static_cast<char>(2);
    cout << "\n\x1b[31m--------------------\x1b[0m\n\n";
    system("pause");
    clear();
    menu();
